  ...
  return (
    <div className="App font-sans">
      <div className="flex justify-around p-5 bg-gray-400 border-gray-500">
        <svg
          className="fill-current text-red-400 w-16 h-16 animate__animated animate__fadeInDownBig"
          id="Layer_1"
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 799.1 698.91"
        >
          <defs>
            <style>.cls-1</style>
          </defs>
      ...
      <div className="grid grid-auto-wrap gap-4 m-6">
        <FeatureCard
          ...
          content={
            <>
              Awesome minecraft capes and elytras, to be{" "}
              <em>earned or purchased!</em>
            </>
          }
        />
        <FeatureCard
        ...
        <FeatureCard
          ...
          title="Placeholder"
          alt="Placeholder"
          content={<>This is some placeholder text, replace it later!</>}
        />
        <FeatureCard
          img={swag}
          title="Placeholder"
